...
# With this setup, the ENTRYPOINT specifies the executable (python GraphAnalysis.py) 
# that should always be run when the container starts. The CMD then provides a default argument (obj_dependency_data.csv) to that executable.
